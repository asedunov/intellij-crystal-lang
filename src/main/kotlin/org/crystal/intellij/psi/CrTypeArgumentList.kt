...
class CrTypeArgumentList : CrStubbedElementImpl<CrTypeArgumentListStub>, CrListElement<CrTypeElement<*>> {
    ...
    override val elementClass: KClass<CrTypeElement<*>>
        get() = CrTypeElement::class
}