...
class CrystalParserTest : ParsingTestCase("parser", "cr", CrystalParserDefinition()) {
    ...
    fun testCallsAndRefs1() = doTestSingleFileWithMultiFragments("\n\n\n")
    fun testCallsAndRefs2() = doTestSingleFileWithMultiFragments("\n\n\n")
    fun testCallsAndRefs_1_1() = project.withLanguageLevel(CrystalLevel.CRYSTAL_1_1) {
        doTestSingleFileWithMultiFragments("\n\n\n")
    }
    fun testCallsAndRefs_1_9() = project.withLanguageLevel(CrystalLevel.CRYSTAL_1_9) {
        doTestSingleFileWithMultiFragments("\n\n\n")
    }
    ...
    fun testHashesAndTuples_1_8() = project.withLanguageLevel(CrystalLevel.CRYSTAL_1_8) {
        doTestSingleFileWithMultiFragments()
    }
    fun testLibraries() = doTestSingleFileWithMultiFragments()
    fun testLibraries_1_7() = project.withLanguageLevel(CrystalLevel.CRYSTAL_1_6) {
        doTestSingleFileWithMultiFragments()
    }
